...
//  Last Modified time: 2018-03-09 15:35:02 by {{last_modified_by}}
...
export default class PhaserComponent {
  ...
  get com_nav_promise() {
    return PhaserComponent._navigator.com_nav_promise
  }

  get com_next_idx() {
    return PhaserComponent._navigator.com_next_idx
  }

  get com_idx() {
    return PhaserComponent._navigator.com_idx
  }
